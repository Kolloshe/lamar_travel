...
class LoadingWidgetMain extends StatefulWidget {
  ...
  @override
  _LoadingWidgetMainState createState() => _LoadingWidgetMainState();
  static String idScreen = 'LoadingWidget';
}
...
class _LoadingWidgetMainState extends State<LoadingWidgetMain> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      Provider.of<AppData>(context, listen: false).userCollectedCoinFromGame(0);
  ...
  //       AnimationController(vsync: this, duration: const Duration(milliseconds: 6000));
  //
  //   _animationCloud = Tween<Offset>(begin: Offset.zero, end: const Offset(0.0, 25.0))
  //       .animate(_animationControllerCloud);
  //   _animationCloud.addListener(() {
  //     globalCloudOffset = Offset(_animationCloud.value.dx, _animationCloud.value.dy * 100);
  //     // print(globalCloudOffset);
  //   });
              ...
              children: [
                Positioned(
                  ...
                  child: Draggable<int>(
                    ...
                    onDragStarted: () {
                      _isOnScreen = true;
                      Provider.of<AppData>(context, listen: false).gundletheDisountDialog(false);
  ...
  void onHit() async {
    ...
    playerScore += 1;
    Provider.of<AppData>(context, listen: false).userCollectedCoinFromGame(playerScore);
...
class CloudTarget extends StatefulWidget {
  ...
  @override
  _CloudTargetState createState() => _CloudTargetState();
}
