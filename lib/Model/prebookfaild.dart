...
//
//     final prebookFalid = prebookFalidFromJson(jsonString);
...
class PrebookFalid {
  ...
  factory PrebookFalid.fromJson(Map<String, dynamic> json) => PrebookFalid(
        code: json["code"],
        error: json["error"],
...
class Data {
  Data(
      ...
      required this.prebooked,
      required this.prebookDetails,
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        specialRequest:
            List<SpecialRequest>.from(json["specialRequest"].map((x) => SpecialRequest.fromMap(x))),

        // List<Map<String, bool>>.from(json["specialRequest"].map(
        //     (x) => Map.from(x).map((k, v) => MapEntry<String, bool>(k, v ?? false)))),
        ...
        prebookDetails:
            json["prebooked"] == false ? PrebookDetails.fromJson(json["prebook_details"]) : null,
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "specialRequest": List<dynamic>.from(specialRequest.map((x) => x.toMap())),

        // List<dynamic>.from(specialRequest?.map((x) =>
        //         Map.from(x).map((k, v) => MapEntry<String, dynamic>(k, v == null ? null : v))) ??
        //     []),
...
class CreditFlagStatus {
  CreditFlagStatus({
    ...
    required this.creditUsedForBooking,
  });
  ...
  factory CreditFlagStatus.fromJson(Map<String, dynamic> json) => CreditFlagStatus(
      ...
      creditUsedForBooking: json['creditUsedForBooking']);
