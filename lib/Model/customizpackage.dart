...
class NewTransfer {
  ...
  factory NewTransfer.fromJson(Map<String, dynamic> json) => NewTransfer(
        ...
        rateKey: json["rateKey"],
        cancellationPolicies: List<TransferCancellationPolicy>.from(
            json["cancellationPolicies"].map((x) => TransferCancellationPolicy.fromJson(x))),
...
class TransferCancellationPolicy {
  ...
  factory TransferCancellationPolicy.fromJson(Map<String, dynamic> json) =>
      TransferCancellationPolicy(
        amount: json["amount"]?.toDouble(),
