...
MainSarchForPackage mainSarchForPackageFromJson(String str) => MainSarchForPackage.fromJson(json.decode(str));
...
class Package {
    ...
    factory Package.fromJson(Map<String, dynamic> json) => Package(
        ...
        flights: (json["flights"] as Map).isEmpty
            ?null
            :  Flights.fromJson(json["flights"]),
